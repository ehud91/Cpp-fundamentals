...
int main() {
    ...
    //std::strlen : Find te lent of a string
    ...
    // Returns negative value if 1hs appears before rhs in lexicographical order,
    // Zero if 1hs and rhs compare equal.
    // and Positive value if 1hs appears after rhs in lexicographical order.
    std::cout << std::endl;
    ...
    std::cout << "std::strncmp (" << string_data5 << "," << string_data6 << "," << n << ") : "
            << std::strncmp(string_data5, string_data6, n) << std::endl;
    ...
    // Find the first accurrence of a character
