...
int main() {
    ...
    std::string prefered_planet {planet}; // Initialize with outher existing string
    std::string message { "Hello there", 5}; // Initialize with part of a string literal
                                             // Contains hello
    std::string weird_message(4,'e'); //Initialize with multiple copies of char
                                       // contains eeee
    std::string greeting {"Hello World"};
    std::string saying_hello {greeting, 6, 5}; // Initialize with part of an existing sta
    ...
    planet1 = "Earth, Where the sky is blue Earth.";
